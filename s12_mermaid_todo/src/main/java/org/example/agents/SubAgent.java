...
public class SubAgent implements IAgent {
    ...
    public SubAgent(AbstractModel model, String agentName) {
        ...
        MemorySystem memorySystem = new MemorySystem(Paths.get(System.getProperty("user.dir"), ".memories"));
        agent.registryAgentCallback(memorySystem);
        agent.registryCommand(memorySystem);

        TaskSystem taskSystem = new TaskSystem(Paths.get(System.getProperty("user.dir"), ".tasks"));
